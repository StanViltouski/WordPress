...
if ( ! function_exists( 'stone_lab_setup' ) ) :
	...
	function stone_lab_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'stone-lab' ),
		) );
...
function stone_lab_scripts() {
	...
	wp_enqueue_style('main-styles', get_template_directory_uri() . '/layouts/app.css');
...
//library style
	wp_enqueue_style('jquery.flipster', get_template_directory_uri() . '/layouts/librarys/jquery.flipster.css');
	wp_enqueue_style('owl.carousel.min', get_template_directory_uri() . '/layouts/librarys/owl.carousel.min.css');
	wp_enqueue_style('owl.theme.default.min', get_template_directory_uri() . '/layouts/librarys/owl.theme.default.min.css');
	wp_enqueue_style('owl.theme.green', get_template_directory_uri() . '/layouts/librarys/owl.theme.green.css');
...
//scripts
	...
	wp_enqueue_script( 'main-scripts', get_template_directory_uri() . '/js/app.js', array(), '20151215', true );
	wp_enqueue_script( 'form', get_template_directory_uri() . '/js/form.js', array(), '20151215', true );
	wp_enqueue_script( 'menu_fixed', get_template_directory_uri() . '/js/menu_fixed.js', array(), '20151215', true );
	wp_enqueue_script( 'showcase_bg', get_template_directory_uri() . '/js/showcase_bg.js', array(), '20151215', true );
...
//library script
	...
	wp_enqueue_script( 'jquery.flipster.min', get_template_directory_uri() . '/js/librarys/jquery.flipster.min.js', array(), '20151215', true );
	wp_enqueue_script( 'owl.animate', get_template_directory_uri() . '/js/librarys/owl.animate.js', array(), '20151215', true );
	wp_enqueue_script( 'owl.autoheight', get_template_directory_uri() . '/js/librarys/owl.autoheight.js', array(), '20151215', true );
	wp_enqueue_script( 'owl.carousel', get_template_directory_uri() . '/js/librarys/owl.carousel.js', array(), '20151215', true );
	wp_enqueue_script( 'owl.carousel.min', get_template_directory_uri() . '/js/librarys/owl.carousel.min.js', array(), '20151215', true );
