...
if ( ! function_exists( 'splendid_setup' ) ) :
	...
	function splendid_setup() {
		...
		register_nav_menus( array(
			'menu' => esc_html__( 'Primary', 'splendid' ),
		) );
...
function splendid_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'splendid_content_width', 640 );
}
...
function splendid_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'splendid' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'splendid' ),
...
function splendid_scripts() {
	wp_enqueue_style( 'splendid-style', get_stylesheet_uri() );
	wp_enqueue_style('splendid-main', get_template_directory_uri() . '/layouts/style.css');
	wp_enqueue_style('splendid-mediaQueries', get_template_directory_uri() . '/layouts/media-queries.css');

	wp_enqueue_script( 'splendid-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'splendid-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
