...
function aletheme_metaboxes($meta_boxes) {
	...
	$meta_boxes[] = array(
		'id'         => 'work_metaboxes',
		'title'      => 'Settings for Work Page',
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'show_on'    => array( 'key' => 'page-template', 'value' => array('template-work.php'), ), // Specific post templates to display this metabox
		'fields' => array(
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'name' => __('Phone-two','aletheme'),
				'desc' => __('Paste your two phone','aletheme'),
				'id'   => $prefix . 'phone-two',
				'std'  => '',
				'type' => 'text',
			),
			...
			array(
				...
				'desc' => __('Paste your map position','aletheme'),
				'id'   => $prefix . 'map',
				'std'  => '',
				'type' => 'textarea_small',
			),
			...
			array(
				...
				'desc' => __('Install CF7 plugin. Create your form. And paste shortcode here.','aletheme'),
				'id'   => $prefix . 'formcode',
				'std'  => '',
				'type' => 'text',
			),
